...
<div class="py-8">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
            ...
            {{-- Mensaje de éxito --}}
            @if(session('success'))
                <div class="bg-green-100 text-green-800 p-3 rounded mb-4 animate-fadeIn">
                    {{ session('success') }}
                </div>
            @endif

            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-300 rounded-md shadow-sm animate-fadeIn">
                    ...
                    <tbody>
                                ...
                                <td class="py-2 px-4 border">
                                    <form action="{{ route('funcionario.incidentes.updateEstado', $incidente->id) }}" method="POST">
                                        ...
                                        <select name="estado" onchange="this.form.submit()" 
                                                class="border rounded-xl px-2 py-1 text-sm transition-all duration-300 hover:scale-105 focus:scale-105 focus:ring-2 focus:ring-rose-300 shadow-md">
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="py-4 text-center text-gray-500 animate-fadeIn">
