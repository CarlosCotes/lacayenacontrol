        ...
        <table class="table-auto w-full text-left">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-2">Empresa</th> {{-- Nueva columna --}}
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2">{{ $acceso->vehiculo->empresa->nombre ?? '-' }}</td> {{-- Empresa --}}
                </tr>
                @empty
                <tr>
                    <td colspan="9" class="text-center py-4 text-gray-500">No hay registros</td>
                </tr>
                @endforelse
            </tbody>
        </table>
