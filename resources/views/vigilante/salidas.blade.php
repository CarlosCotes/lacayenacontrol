    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('vigilante.storeSalida') }}" method="POST" class="space-y-4">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        ...
                        <button type="submit" 
                            class="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded shadow-md transition duration-150">
                            Registrar Salida
                        </button>
                    </div>
